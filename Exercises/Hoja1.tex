...
\ejercicio{
    ...
    \begin{enumerate}
        ...
        Ahora si despejamos:
        \[
            - \frac{F_0}{4\omega^2} \cos(\omega t) \cos(2\omega t) + \frac{F_0}{4\omega^2} \sin(\omega t) \sin(2\omega t) =
            \frac{F_0}{4\omega^2} \left(- \cos(\omega t) \cos(2\omega t) + \sin(\omega t) \sin(2\omega t)\right) =
            \frac{F_0}{4\omega^2} \cos(\omega t)
        \]
        Por lo que nos queda:
        \[
            u(t) = \frac{F_0}{4\omega^2} \cos(\omega t) + x_1 \cos(\omega t) + x_2 \sin(\omega t)
        \]
        Aplicando ahora las condiciones iniciales:
        \[
            u(0) = - \frac{F_0}{4\omega^2} + x_1 = 0 \implies
            x_1 = \frac{F_0}{4\omega^2}
        \]
        \[
            u'(t) = -\omega \sin(\omega t) \cdot \left(- \frac{F_0}{4\omega^2} \cos(2\omega t) + x_1\right) + \cos(\omega t) \cdot \left(- \frac{F_0}{4\omega^2} \cdot (-2\omega) \sin(2\omega t)\right) +
        \]
    \end{enumerate}
}
