...
\ejercicio{enunciado}{no}{
    ...
    \[
        P(D) = D^3 + 3D^2 + 3D + 1 = (D+1)^3
    \]

    \[
        \mathcal{B} = \{ e^{-t}, te^{-t}, t^2 e^{-t} \} \text{ base de } \Sigma_0
    \]

    \[
        P(D) u = \pi \implies p_1(t) = \pi
    \]
    \[
        P(D) u = e^t \implies p_2(t) = B e^t
    \]
    ...
    \]
    \[
        BP(D) (e^t) = BP(1) e^t = 8B e^t \implies B = \frac{1}{8}
    \]

    \[
        u(t) = x_1 e^{-t} + x_2 te^{-t} + x_3 t^2 e^{-t} + \pi + \frac{1}{8} e^t
    \]
}
...
\ejercicio{enunciado}{no}{
    ...
    \begin{enumerate}
        ...
        \]
        \[
            z^4 - 8z^3 + 26z^2 - 40z + 25 = (z-2)^4 + 2z^2 -8z + 9 = (z-2)^4 + 2(z^2-4z+4) + 1 
        \]
        \[
            = (z-2)^4 + 2(z-2)^2 + 1 = ((z-2)^2 + 1)^2
        \]
        Luego las raíces del polinomio característico son $1, -1$ simples y $2 + i, 2 - i$ dobles. Por lo tanto, una base de $\Sigma_0$ es
        \[
            \mathcal{B} = \{ e^t, e^{-t}, e^{2t} \cos t, e^{2t} \sin t, t e^{2t} \cos t, t e^{2t} \sin t \}
        \]
        \[
            P(D) u = 1 \implies P(D) K = 1 \iff - 25 K = 1 \implies K = -\frac{1}{25}
        \]
        \[
            P(D) u = e^{2t} \implies P(D) (m e^{2t}) = e^{2t} \iff m P(D) ( e^{2t} ) = e^{2t} 
        \]
        \[
            m P(2) e^{2t} = e^{2t} \implies m (1 \cdot 3 (12-2)^2+1)e^{2t} = e^{2t} \implies m = \frac{1}{3}
        \]
        \item[(b)]
        \[
            P(z) = z^4 - 4z^3 + 12z^2 + 4z - 13 = (z-1)(z+1)((z-2)^2 + 9)
        \]
        Luego las raíces del polinomio característico son $1, -1$ simples y $2 + 3i, 2 - 3i$ dobles. Por lo tanto, una base de $\Sigma_0$ es
        \[
            \mathcal{B} = \{ e^t, e^{-t}, e^{2t} \cos(3t), e^{2t} \sin(3t), t e^{2t} \cos(3t), t e^{2t} \sin(3t) \}
        \]
    \end{enumerate}
}
