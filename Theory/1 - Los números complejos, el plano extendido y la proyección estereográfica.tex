...
Para resolver el sistema inhomogéneo mediante el método de \textbf{variación de los parámetros}, planteamos $W(t)C'(t) = B(t)$, con $C(t) = \begin{pmatrix} c_1(t) \\ c_2(t) \end{pmatrix}$:
...
\[ c_1'(t) = \frac{\begin{vmatrix} 0 & e^{\lambda_2 t} \\ b(t) & \lambda_2 e^{\lambda_2 t} \end{vmatrix}}{\det W(t)} = \frac{-b(t)e^{\lambda_2 t}}{(\lambda_2 - \lambda_1) e^{(\lambda_1 + \lambda_2)t}} \]
\[ c_2'(t) = \frac{\begin{vmatrix} e^{\lambda_1 t} & 0 \\ \lambda_1 e^{\lambda_1 t} & b(t) \end{vmatrix}}{\det W(t)} = \frac{b(t)e^{\lambda_1 t}}{(\lambda_2 - \lambda_1) e^{(\lambda_1 + \lambda_2)t}} \]

Finalmente, para hallar la solución general, basta con integrar $c_1'(t)$ y $c_2'(t)$, obtener las funciones $c_1(t)$ y $c_2(t)$, y sustituirlas para recuperar la primera componente del vector de soluciones.
}