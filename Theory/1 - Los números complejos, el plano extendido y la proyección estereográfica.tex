...
\ejemplo{
    ...
    Consideramos la ecuación diferencial lineal de segundo orden con coeficientes constantes:
    \[ u'' = a_0 u + a_1 u' + b ,    a_0, a_1, b \in \mathbb{C} \]
    La ecuación homogénea asociada es:
    \[ h'' = a_0 h + a_1 h' \]
    Proponemos soluciones exponenciales de la forma $h(t) = e^{\lambda t}$.Sustituyendo obtenemos:
    \[ \lambda^2 e^{\lambda t} = a_0 e^{\lambda t} + a_1 \lambda e^{\lambda t} \implies \lambda^2 - a_1 \lambda - a_0 = 0 \]
    Las raíces de este polinomio característico, $\lambda_1, \lambda_2 \in \mathbb{C}$, definen la base del espacio de soluciones $B$:
    \begin{itemize}
        \item Si $\lambda_1 \neq \lambda_2$, entonces $B = \{e^{\lambda_1 t}, e^{\lambda_2 t}\}$.
        \item Si $\lambda_1 = \lambda_2 \neq 0$, entonces $B = \{e^{\lambda_1 t}, te^{\lambda_1 t}\}$.
        \item Si $\lambda_1 = \lambda_2 = 0$, entonces $B = \{1, t\}$.
    \end{itemize}

    Para encontrar una solución particular a la ecuación inhomogénea, analizamos distintos casos:
    \begin{itemize}
        \item \textbf{Caso $a_0 \neq 0$}: Proponemos una solución constante $u = c$. Derivando obtenemos $u' = u'' = 0$. Sustituyendo en la ecuación $0 = a_0 c + b$, despejamos $c = \frac{-b}{a_0}$.
        \item \textbf{Caso $a_0 = 0$}: La ecuación se reduce a $u'' = a_1 u' + b$. Bajamos el orden con $u' = v$, obteniendo $v' = a_1 v + b$. Proponiendo una solución constante para $v$, tenemos $v = \frac{-b}{a_1}$. Deshaciendo el cambio, $u' = \frac{-b}{a_1}$, cuya integración da como solución particular $u(t) = -\frac{b}{a_1}t$.
        \item \textbf{Caso $a_0 = a_1 = 0$}: La ecuación es simplemente $u'' = b$. Integrando directamente dos veces obtenemos $u' = bt + x$ y $u(t) = b\frac{t^2}{2} + xt + y$ con $x,y \in \mathbb{R}$. La solución particular es $u_p(t) = b\frac{t^2}{2}$.
    \end{itemize}
}
\ejemplo{
...
\[
    E_T = \underbrace{\frac{1}{2} m [u'(t)]^2}_{\text{E. Cinética}} + \underbrace{\frac{1}{2} k [u(t)]^2}_{\text{E. Potencial}} = \frac{1}{2} m v_0^2 + \frac{1}{2} k u_0^2
\]