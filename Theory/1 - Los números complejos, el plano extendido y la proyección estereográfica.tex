...
\[
    = \frac{a}{\sqrt{(k - m \gamma^2)^2 + (r \gamma)^2}} \sin(\gamma t + \varphi)
\]

Sumamos a la solución homogénea la solución particular que acabamos de encontrar, y obtenemos la solución general:

\[
    u(t) = \underbrace{e^{-\frac{r}{2m} t} (x_1 \cos(\Omega t) + x_2 \sin(\Omega t))}_{\text{régimen transitorio}} + \underbrace{\frac{a}{\sqrt{(k - m \gamma^2)^2 + (r \gamma)^2}} \sin(\gamma t + \varphi)}_{\text{régimen permanente}}
\]