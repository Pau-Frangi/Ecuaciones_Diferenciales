...
\begin{tikzpicture}[thick, >=stealth]
  ...
  \coordinate (U0) at (0, 0);
  \fill (U0) circle (2pt);
  \node[anchor=north, yshift=-2pt] at (U0) {$u_0$};

  % Familia de órbitas anidadas (elipses concéntricas)
  \draw (U0) ellipse (1 and 0.4);
  \draw (U0) ellipse (1.6 and 0.7);
  \draw (U0) ellipse (2.2 and 1.0);
  \draw (U0) ellipse (2.8 and 1.3);
