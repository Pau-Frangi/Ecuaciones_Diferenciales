...
\begin{teorema}[Teorema de unicidad global]
    Bajo las condiciones del teorema local de Cauchy-Lipschitz, la solución es única en cualquier intervalo de la forma $[t_0, t_0 + h]$ o $[t_0, t_0 + h)$ donde esté definida.    
\end{teorema}

\begin{proof}
    $[t_0, t_0 + h]$ donde $(P)$ tiene al menos una solución, supongamos que hay dos soluciones $u_1(t)$ y $u_2(t)$ definidas en dicho intervalo, por lo que si son distintas $\exists \widetilde{t} \in [t_0, t_0 + h)$ tal que $u_1(\widetilde{t}) \neq u_2(\widetilde{t})$.\\
\end{proof}